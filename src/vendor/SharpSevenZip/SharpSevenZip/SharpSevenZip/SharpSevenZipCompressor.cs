        ...
        : SharpSevenZipBase
{
    ...
    {
        _tempArchiveFileName ??= Path.Combine(TempFolderPath!, Path.GetRandomFileName());
        return _tempArchiveFileName;
    }
    ...
    private void FinalizeUpdate()
    {
        ...
        {
            var tempFileName = GetTempArchiveFileName(_archiveName!);
            File.Move(tempFileName, _archiveName!);
