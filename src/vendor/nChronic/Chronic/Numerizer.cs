...
namespace Chronic
{
    ...
    {
        static readonly object[,] DIRECT_NUMS = new object[,]
            {
                {"eleven", "11"},
                {"twelve", "12"},
                {"thirteen", "13"},
        ...
        static readonly object[,] ORDINALS = new object[,]
            {
                {"first", "1"},
                {"third", "3"},
                {"fourth", "4"},
        ...
        static readonly object[,] TEN_PREFIXES = new object[,]
            {
                {"twenty", 20},
                {"thirty", 30},
                {"forty", 40},
        ...
        static readonly object[,] BIG_PREFIXES = new object[,]
            {
                {"hundred", 100},
                {"thousand", 1000},
                {"million", 1000000},
