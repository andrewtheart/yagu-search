...
{
    /// <summary>Minimum fraction of probes a model must answer correctly (0..1). At 0.75, a 6-probe set
    /// tolerates at most one miss.</summary>
    public const double MinAccuracy = 0.75;
