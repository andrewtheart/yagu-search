...
public sealed partial class MainWindow
{
    ...
    private bool HasOpenAppOwnedWindowOrModal()
        => IsLauncherHideTemporarilySuppressed() || _directoryBrowseInProgress || _settingsWindow is not null || _helpWindow is not null || _ownedModalWindowDepth > 0 || YaguDialog.HasOpenOwnedWindow(_hwnd) || PreviewEditorWindow.HasOpenOwnedWindow(_hwnd);
