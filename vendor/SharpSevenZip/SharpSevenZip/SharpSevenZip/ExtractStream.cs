...
internal class ExtractStream : Stream
{
    ...
    private const int MaxQueuedChunks = 1024;
    ...
    public override void Write(byte[] buffer, int offset, int count)
    {
        ...
        // Backpressure: wait if queue is too large to prevent unbounded memory growth
        while (_data.Count >= MaxQueuedChunks && _isOpen)
        {
            Thread.SpinWait(100);
        }
