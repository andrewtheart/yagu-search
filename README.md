...
| [**Arm64** — YaguSetup-1.0.0.2392-arm64.exe](https://github.com/andrewtheart/yagu-search/releases/download/v1.0.0.2392/YaguSetup-1.0.0.2392-arm64.exe) (~190 MB) | Windows on ARM: Snapdragon-based laptops, Surface Pro X, Windows Dev Kit. | Works. Defaults to PaddleOCR; the OCR runtime and models download once on first use. |
| [**x86** — YaguSetup-1.0.0.2392-x86.exe](https://github.com/andrewtheart/yagu-search/releases/download/v1.0.0.2392/YaguSetup-1.0.0.2392-x86.exe) (~171 MB) | 32-bit Windows. | Works. Defaults to the Tesseract engine (PaddleOCR's runtime is x64-only); language data downloads once on first use. |
