...
public sealed class AppSettings
{
    ...
    public int ParallelismIndex { get; set; } // 0 = Auto, 1 = 1, 2 = half cores, 3 = 2x cores
    ...
    /// <summary>System-wide memory pressure threshold (0-100). Search truncates when total machine memory usage exceeds this %. 0 = disabled.</summary>
