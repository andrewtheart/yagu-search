---
description: "Deploy Yagu to the Azure Static Site. Builds, packages, uploads ZIP to private downloads container, and updates ONLY the Yagu card in the shared index.html. Use when: deploy to static site, publish to azure, upload to download site, push release."
mode: "agent"
---
