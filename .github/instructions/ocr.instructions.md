...
- Default engine is **arch/edition-aware**: x86 and the offline edition default to **Tesseract**;
  every other build defaults to **PaddleSharp** (`AppSettings.ResolveDefaultImageOcrEngine`).
